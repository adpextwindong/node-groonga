...
import groongaHttp from "./protocol/http.mjs";
...
Groonga.prototype.removeColumn = function(table, name, cb) {
  return this.call("column_remove", {
    "table" : table,
    "name" : name
  }, cb);
};

Groonga.prototype.getColumnList = function(table, cb) {
  return this.call("column_list", {
    "table" : table
  }, cb);
};
...
Groonga.prototype.logPut = function(level, message, cb) {
...
Groonga.prototype.suggest = function(types, table, column, query, cb) {
